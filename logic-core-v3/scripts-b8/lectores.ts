/**
 * COPIA ATRIBUIDA DE `scripts-b6/lectores.ts` (B6-A, rama `v3/escena-viva`, 21b9d89e).
 *
...
export const ATRIBUTO_DE_BLOQUE = 'data-b8-bloque'
export const ATRIBUTO_DE_CAMPO = 'data-b8-campo'
const ID_DEL_ESTILO = 'b8-sin-tinta'
 ...
 * `data-b8-bloque` para poder apagarles la tinta después. Salta lo recortado
