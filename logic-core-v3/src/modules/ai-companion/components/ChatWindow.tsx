                                    ...
                                    messages.map((m, idx) => (
                                        ...
                                        >
                                            <div className={`relative max-w-[85%] rounded-2xl p-4 border ${m.role === 'user'
                                                ...
                                                {/* WhatsApp Contact Card — triggered by [ACTION: SHOW_CONTACT] or [SHOW_CONNECT_FORM] */}
                                                {m.role === 'assistant' &&
                                                    (getTextContent(m).includes('[ACTION: SHOW_CONTACT]') ||
                                                        ...
                                                        >
                                                            <div className="rounded-2xl p-5 border border-cyan-900/40 shadow-[0_0_25px_rgba(6,182,212,0.08)]"
                                                                style={{
                                                                    background: 'linear-gradient(135deg, rgba(0,0,0,0.5) 0%, rgba(6,182,212,0.03) 100%)',
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-center gap-2 mb-3">
                                                                    ...
                                                                    <span className="text-[10px] font-mono text-emerald-400/80 uppercase tracking-[0.15em]">Canal directo activo</span>
                                                                </div>

                                                                <h4 className="text-zinc-100 font-medium text-sm mb-1.5 tracking-wide">
                                                                    Inicia tu proyecto con DevelOP
                                                                </h4>
                                                                <p className="text-zinc-500 text-xs mb-4 leading-relaxed">
                                                                    Conectá directamente con el equipo de ingeniería. Te armamos una propuesta personalizada.
                                                                </p>
                                                                ...
                                                                <a
                                                                    ...
                                                                    className="group/wa flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300
                                                                        bg-emerald-950/40 hover:bg-emerald-900/60 border border-emerald-800/50 hover:border-emerald-600/60
                                                                        text-emerald-50 hover:shadow-[0_0_20px_rgba(52,211,153,0.15)]"
                                                                >
