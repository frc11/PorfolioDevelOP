 ...
 * (P37: fijado → respondió → caliente → antigüedad, el mismo orden «urgencia» de
 * la cartera). NO clasifica, NO prioriza y NO transiciona: es POSICIONAL — toma la
 * cima de la cola que le entregan y respeta el sticky (D7). El criterio vive en
 * `flow.ts` (`ordenFoco`); cambiarlo NO toca este archivo.
 *
