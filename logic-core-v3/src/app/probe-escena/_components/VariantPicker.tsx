...
/**
 * EL SELECTOR DE RECORRIDO (S7).
 *
 * Cuatro botones y una línea de texto. Cambia la coreografía **en vivo**: el
 ...
 *
 * 1. **Cuál es la base.** Va primera y con su tesis escrita: es la coreografía
 *    que el humano calibró mirando, y las otras tres son propuestas. Perder de
 *    vista esa diferencia es perder de vista qué número está medido y cuál no.
...
const BUTTON_BASE =
  'flex-1 rounded-sm border px-1 py-1.5 text-[0.64rem] leading-none transition-colors'
...
export function VariantPicker({ editor }: VariantPickerProps) {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex gap-1" role="group" aria-label="recorrido">
