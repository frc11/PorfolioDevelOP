 ...
 * INVARIANTE — 01 · Hero.
 *
 * Corre con `npx tsx src/app/v3/secciones-a/hero/hero.invariant.tsx`.
 *
...
afirmarIgual(veces(conPreferencia, 'data-texto-por-lineas="entero"'), 1, '  y con la preferencia vuelve a salir entero: la política de S2 gana sobre el modo forzado')
...
controlPositivo('el chequeo de entradas colgadas ve una ruta inventada', [{ ruta: 'no.existe', clase: 'prosa' as const, que: 'nada' }], (p) => entradasColgadas(CONTENIDO, p).length === 0)
