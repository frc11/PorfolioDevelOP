 ...
 * para pasar a ser una búsqueda. Estos seis cubren lo que las cuatro secciones
 * necesitan, y agregar el séptimo es editar esta línea, que es exactamente el
 * momento en que alguien tiene que pensarlo.
 *
