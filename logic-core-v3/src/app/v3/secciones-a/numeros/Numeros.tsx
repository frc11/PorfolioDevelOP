...
/**
 * Un bloque P2 con su única pieza, y su rama quieta. Existe para que las SEIS
 * instancias no repitan el `estado.progreso === null`: seis copias son seis
 * oportunidades de que una se desvíe y quede sin variante quieta — el defecto
 * que ninguna revisión de "se ve bien" encontraría, porque arriba de 1025 se
 * ve bien igual.
 */
function SubeEntero({
  estado,
          ...
          <Grilla columnas="lateral">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div data-composicion="dispersa" className={CLASES_DE_LA_COMPOSICION}>
                ...
                <BloqueDeSeccion patron="P2" piezas={1} className={GEOMETRIA.cabecera}>
                  {(estado) => (
                    <SubeEntero estado={estado} className="flex flex-col gap-4">
