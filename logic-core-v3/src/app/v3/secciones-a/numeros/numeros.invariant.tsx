 ...
 *
 * Corre con `npx tsx src/app/v3/secciones-a/numeros/numeros.invariant.tsx`.
 *
...
const seccion = seccionDeA('numeros')
...
afirmar(!conPreferencia.includes('transform:'), 'y con `prefers-reduced-motion` tampoco, con el modo forzado')
...
controlPositivo('ve una ruta inventada', [{ ruta: 'no.existe', clase: 'prosa' as const, que: 'nada' }], (p) => entradasColgadas(CONTENIDO, p).length === 0)
