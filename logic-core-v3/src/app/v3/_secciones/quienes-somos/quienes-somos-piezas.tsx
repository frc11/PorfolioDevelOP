 ...
 * navegador: una SIN las primitivas animadas instaladas —que es lo que ocurre
 * abajo de 1025 y con `prefers-reduced-motion`— y otra con ellas. Todas las
 * afirmaciones son sobre el MARCADO que sale, no sobre la intención del
 * componente. El renderizador está en `_invariantes/render.tsx`, una sola vez
 * para las ocho.
 *
...
export const seccion = seccionDe('quienes-somos')

const seccionMontada = <QuienesSomos seccion={seccion} />

/** La rama de abajo de 1025 — y la misma que produce la preferencia de S2. */
export const quieto = marcar(seccionMontada, { anima: false })
/** El control positivo: la coreografía instalada, sin la preferencia. */
export const conMotion = marcar(seccionMontada, { anima: true })
/**
 ...
 */
export const conPreferencia = marcar(seccionMontada, { anima: false, preferencia: 'always' })
