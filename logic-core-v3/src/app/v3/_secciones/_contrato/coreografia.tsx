 ...
 *
 * Es el contrato que consumen las ocho secciones: declara las primitivas y las
 * implementa QUIETAS, sin un solo import de valor del sistema de motion; las
 * animadas llegan por contexto desde un chunk perezoso, sólo arriba del umbral.
 * **El problema que resuelve, y qué NO puede tener: `coreografia.doc.md`.**
 */
