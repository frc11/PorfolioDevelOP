...
import { ATRIBUTO_DEL_TITULAR, TIPOGRAFIA_DEL_TITULAR, TIPOGRAFIA_DEL_REGISTRO_2 } from './geometria'
import { Hero } from './Hero'
import { afirmarElContrasteSobreElCanvas, afirmarElPieDeLaPantalla } from './soporte'
...
// ═══════════════════════════════════════════════════════════════════════════
// ⚠️ §9 Y §10 VIVEN EN `soporte.ts` — las CUENTAS del frente, contra las que
// miran el MARCADO, que quedan acá.
...
// ═══════════════════════════════════════════════════════════════════════════
titulo('12 · El pedido y los patrones declarados')
