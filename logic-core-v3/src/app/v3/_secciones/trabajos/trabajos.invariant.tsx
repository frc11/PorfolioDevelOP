...
afirmarIgual(veces(quieto, '<h3'), 4, 'y cuatro h3: uno por proyecto y el de las demos')
afirmarIgual(veces(conMotion, '<h3'), 4, '  también con la coreografía: los tres planos existen igual, y las demos también')
