...
// Modo pulido: la CUENTA se aflojó —cada ventana nueva agrega una rama— y lo que se sigue afirmando es el ORDEN.
afirmar(LINEAS.length >= 4, 'resuelve en una cadena de ramas, no en una sola')
...
afirmar(LINEAS[LINEAS.length - 1].includes('PATRONES[props.patron].anclas'), 'y el defecto sigue siendo el ancla del patrón, y va último')
afirmar(
