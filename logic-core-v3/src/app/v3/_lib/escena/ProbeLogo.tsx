...
export function ProbeLogo({ stats, onReady, celosia }: ProbeLogoProps) {
   ...
   * intensidad que se le ponga, sigue siendo negro—; lo único que dibuja su
   * volumen es el reflejo especular, que no depende del albedo. Con 0,52 ese
   * reflejo estaba tan repartido que el logo se leía plano; con `INK_ROUGHNESS`
   * el lóbulo se cierra lo suficiente para que la cara, el bisel y el canto se
   * separen, y para que el contraluz tenga dónde dibujarse. El porqué del valor
