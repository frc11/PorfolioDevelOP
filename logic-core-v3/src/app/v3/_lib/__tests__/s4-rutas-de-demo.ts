...
/** Lo que tiene que volver al borrar las cinco, medido hoy. */
...
export function textoDeLaPrediccion(): string {
  ...
  return [
    ...
    `             ${HEREDADO_SIN_DEMOS_KIB} KiB crudo (±${TOLERANCIA_PREDICCION_KIB}), o sea recuperar ${RECUPERO_ESPERADO_KIB} KiB,`,
    '             sin tocar ninguna otra cosa.',
