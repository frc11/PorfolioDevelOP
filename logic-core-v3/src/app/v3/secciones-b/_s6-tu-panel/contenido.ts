 ...
 * prueba va un marcador del vocabulario de `_contrato/contenido.ts`, y el
...
import type { IdDeSeccionB } from '../_contrato/secciones'

export const ID: IdDeSeccionB = 'tu-panel'
