...
/** Los marcadores del vocabulario. Un texto de relleno usa ESTOS y no otros. */
...
/**
 * Los únicos números que este lane puede escribir en el contenido visible.
 *
...
export const NUMEROS_PERMITIDOS: readonly Excepcion[] = [
  { valor: '05', motivo: 'número de sección — Servicios. Estructura del recorrido, no un dato.' },
  { valor: '06', motivo: 'número de sección — Tu panel.' },
  { valor: '07', motivo: 'número de sección — Por qué develOP.' },
  { valor: '08', motivo: 'número de sección — Cierre.' },
  {
    valor: '1025',
    motivo:
