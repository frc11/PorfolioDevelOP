 ...
 *
 * Corre con `npx tsx src/app/v3/secciones-b/_s8-cierre/s8-cierre.invariant.tsx`.
 *
...
import { ritmoDe, seccionDe } from '../_contrato/secciones'
...
const SIN = renderToStaticMarkup(<Cierre anima={false} />)
const CON = renderToStaticMarkup(<Cierre anima={true} />)
...
const bajoSuperficie = (superficie: 'papel-opaco' | 'oscuro-opaco'): string =>
  renderToStaticMarkup(<Panel seccion={{ ...seccionDe('cierre'), superficie }}><ContenidoDelCierre anima={false} /></Panel>)
