...
// Reusa el panel de emoji del chatbot (el sitio que ya importa emoji-picker-react).
// Lazy + ssr:false → el chunk se baja recién en el primer open, y solo en admin.
// Mismo enfoque que EmojiPickerField de la config del chatbot.
...
// El composer vive al fondo del inbox → el panel abre SIEMPRE hacia arriba.
// Portaleado a body con position:fixed para no quedar clippeado por el
