...
const TAB_ITEMS = [
  {
    label: 'Overview',
    href: (projectId: string) => `/admin/projects/${projectId}`,
    key: 'overview',
  },
  {
    label: 'Tareas',
    href: (projectId: string) => `/admin/projects/${projectId}/tasks`,
    key: 'tasks',
  },
  {
    label: 'Horas',
    href: (projectId: string) => `/admin/projects/${projectId}/hours`,
    key: 'hours',
  },
  {
    label: 'Pagos',
    href: (projectId: string) => `/admin/projects/${projectId}/payments`,
    key: 'payments',
  },
] as const
