...
import { AlarmClock, Hammer, Lock, OctagonAlert, Save } from 'lucide-react'
import type { DossierStage } from '@prisma/client'
import { Badge, Button, Card } from '@/components/ui'
import type { Brief, Rechazo } from '@/lib/leados/contracts'
      ...
      <Card padding="lg" className="space-y-5">
        ...
        {brief && (
          <CopyBlock
            ...
            instruccion="El brief listo para pegar como primer mensaje."
            texto={buildConstruccionBlock(lead, brief)}
          />
        )}
