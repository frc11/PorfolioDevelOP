...
const STATS = [
  { label: 'Mensajes recibidos', value: '284', icon: MessageCircle, color: 'text-green-400', bg: 'bg-green-500/10' },
  { label: 'Leads calificados', value: '47', icon: Users, color: 'text-cyan-400', bg: 'bg-cyan-500/10' },
  { label: 'Tasa respuesta automática', value: '94%', icon: CheckCircle2, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  { label: 'Tiempo respuesta promedio', value: '< 2 min', icon: Clock, color: 'text-amber-400', bg: 'bg-amber-500/10' },
]
