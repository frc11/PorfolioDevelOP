...
import { Target, Users, DollarSign, TrendingUp, ExternalLink } from 'lucide-react'
...
const STATS = [
  { label: 'Visitantes trackeados', value: '1.247', icon: Users, color: 'text-cyan-400', bg: 'bg-cyan-500/10' },
  { label: 'Recuperados', value: '89', icon: Target, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  { label: 'Costo por recuperación', value: 'USD 12', icon: DollarSign, color: 'text-amber-400', bg: 'bg-amber-500/10' },
  { label: 'ROI de campaña', value: '340%', icon: TrendingUp, color: 'text-violet-400', bg: 'bg-violet-500/10' },
]
