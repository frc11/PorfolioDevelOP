...
import { Search, TrendingUp, Users, Trophy, FileText, CheckCircle2, Clock } from 'lucide-react'
...
const STATS = [
  { label: 'Posición promedio', value: '4.2', icon: Search, color: 'text-cyan-400', bg: 'bg-cyan-500/10' },
  { label: 'Keywords en top 3', value: '8', icon: Trophy, color: 'text-amber-400', bg: 'bg-amber-500/10' },
  { label: 'Tráfico orgánico mensual', value: '1.2K', icon: TrendingUp, color: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  { label: 'Competidores superados', value: '3', icon: Users, color: 'text-violet-400', bg: 'bg-violet-500/10' },
]
