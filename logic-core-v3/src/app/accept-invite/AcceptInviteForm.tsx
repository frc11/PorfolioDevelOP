    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-10 text-center">
        ...
        <p className="mt-3 text-sm text-zinc-600">
          Activá tu cuenta y definí tu contraseña
        </p>
      </motion.div>
      ...
      >
        {isInvalidToken ? (
          ...
          <div className="flex flex-col items-center gap-4 py-2 text-center">
            ...
            <div>
              <p className="text-sm font-medium text-zinc-200">Invitación inválida</p>
              <p className="mt-1.5 text-xs leading-relaxed text-zinc-500">
                Este enlace de invitación no es válido o ya expiró.
                Contactá al equipo develOP para obtener uno nuevo.
              </p>
            </div>
            <Link
              href="/login"
          ...
          >
            ...
            <div>
              <p className="text-sm font-medium text-zinc-200">Cuenta activada</p>
              <p className="mt-1.5 text-xs leading-relaxed text-zinc-500">
                Tu cuenta fue creada correctamente. Ya podés ingresar al portal.
              </p>
            </div>
          ...
          <form action={formAction} className="flex flex-col gap-5">
            ...
            <motion.p variants={itemVariants} className="text-xs leading-relaxed text-zinc-500">
              Elegí una contraseña segura para acceder a tu portal de cliente develOP.
            </motion.p>
