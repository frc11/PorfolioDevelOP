    ...
    <>
      <div
        style={{
          ...
          height: '500px',
          background:
            'radial-gradient(ellipse, rgba(15,191,115,0.08) 0%, rgba(0,255,136,0.04) 40%, transparent 65%)',
          filter: 'blur(100px)',
          pointerEvents: 'none',
          zIndex: 0,
        }}
  ...
  return (
    ...
    >
      <div style={{ display: 'flex' }}>
        {['#00ff88', '#0fbf73', '#00ff88', '#0fbf73', '#00ff88'].map((c, i) => (
          <div
            key={i}
            style={{
              width: '32px',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '3px' }}>
        <div style={{ display: 'flex', gap: '2px' }}>
          {[0, 1, 2, 3, 4].map((i) => (
            <span key={i} style={{ fontSize: '16px', color: '#00ff88' }}>*</span>
          ))}
        </div>
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          height: '1px',
          background: 'linear-gradient(90deg, transparent, rgba(0,255,136,0.3) 30%, rgba(15,191,115,0.3) 70%, transparent)',
      ...
      >
        <div style={{ textAlign: 'left' }}>
          ...
          <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.15)', letterSpacing: '0.1em' }}>TUCUMAN - ARGENTINA</span>
        </div>
