...
export default function CtaIA() {
  ...
  const waText = encodeURIComponent("Hola develOP, quiero el diagnostico gratuito de IA")
    ...
    <section className="relative py-32 w-full overflow-hidden bg-[#080810]">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 flex items-center justify-center z-0">
        <div
          ...
          style={{
            background: "radial-gradient(circle at center, rgba(34,197,94,0.07) 0%, transparent 60%)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <motion.div
          ...
          style={{
            ...
            boxShadow: "0 0 60px rgba(34,197,94,0.06), 0 20px 40px rgba(0,0,0,0.3)",
          }}
        >
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, rgba(34,197,94,0.7) 30%, rgba(22,163,74,0.9) 50%, rgba(34,197,94,0.7) 70%, transparent)",
            }}
          />
          ...
          >
            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" style={{ boxShadow: "0 0 8px rgba(22,163,74,0.7)" }} />
            <span className="text-[11px] font-mono font-bold uppercase tracking-[0.18em] text-red-400">
              Capacidad limitada - proximas 2 semanas: 2 proyectos disponibles
            </span>
          </motion.div>
          ...
          >
            Tu empresa con IA{" "}
            <span style={{ color: "#34d399", textShadow: "0 0 16px rgba(52,211,153,0.22)" }}>en 30 dias.</span>
          </h2>

          <p className="max-w-xl mx-auto text-base leading-relaxed mb-12" style={{ color: "rgba(255,255,255,0.45)" }}>
            Empezamos con un diagnostico gratuito de 45 minutos donde identificamos los 3 procesos de tu empresa
            donde la IA genera mas impacto inmediato. Sin compromiso, sin tecnicismos.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              style={{
                ...
                color: "white",
                boxShadow: "0 0 30px rgba(34,197,94,0.35), 0 8px 20px rgba(0,0,0,0.3)",
              }}
            >
          ...
          <p className="text-[11px] font-mono uppercase tracking-widest mt-8" style={{ color: "rgba(255,255,255,0.22)" }}>
            Tucuman - Argentina - Respondemos en &lt;2 horas habiles
          </p>
        </motion.div>
      </div>
    </section>
