        ...
        <section className="relative py-32 w-full overflow-hidden bg-[#080810]">
            ...
            >
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(circle at center, rgba(139,92,246,0.07) 0%, transparent 60%)",
                    }}
                />
            </div>
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
                <motion.div
                    ...
                    style={{
                        background:
                            "linear-gradient(135deg, rgba(139,92,246,0.06) 0%, rgba(168,85,247,0.03) 100%)",
                        border: "1px solid rgba(139,92,246,0.18)",
                        padding: "clamp(48px,7vh,80px) clamp(24px,6vw,80px)",
                        boxShadow: "0 0 60px rgba(139,92,246,0.06), 0 20px 40px rgba(0,0,0,0.3)",
                    }}
                >
                    {/* Top shimmer */}
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(90deg, transparent, rgba(139,92,246,0.7) 30%, rgba(168,85,247,0.9) 50%, rgba(139,92,246,0.7) 70%, transparent)",
                        }}
                    />
                    ...
                    >
                        ...
                        <span className="text-[11px] font-mono font-bold uppercase tracking-[0.18em] text-red-400">
                            Capacidad limitada — próximas 2 semanas: 2 proyectos disponibles
                        </span>
                    </motion.div>
                    ...
                    >
                        Empezamos con un diagnóstico gratuito de 45 minutos donde identificamos
                        los 3 procesos de tu empresa donde la IA genera más impacto inmediato.
                        Sin compromiso, sin tecnicismos.
                    </p>

                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a
                            href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? '5493816223508'}?text=Hola%20develOP%2C%20quiero%20el%20diagn%C3%B3stico%20gratuito%20de%20IA`}
                            target="_blank"
                            ...
                            style={{
                                ...
                                color: "white",
                                boxShadow: "0 0 30px rgba(139,92,246,0.35), 0 8px 20px rgba(0,0,0,0.3)",
                            }}
                        >
                    ...
                    >
                        Tucumán · Argentina · Respondemos en &lt;2 horas hábiles
                    </p>
                </motion.div>
            </div>
        </section>
