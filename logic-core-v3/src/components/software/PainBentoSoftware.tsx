...
const bentoPairs: BentoPair[] = [
  {
    ...
    caos: {
      ...
      detail: '3-4 horas/día perdidas en planillas',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
  ...
  },
  {
    ...
    caos: {
      ...
      detail: '~40% de pedidos sin respuesta en las primeras 2 horas',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
  ...
  },
  {
    ...
    caos: {
      ...
      detail: '22 minutos promedio por proceso manual',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
  ...
  },
  {
    ...
    caos: {
      ...
      detail: '1 de cada 5 operaciones tiene un error manual',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
  ...
  },
  {
    ...
    caos: {
      ...
      detail: '4-6 horas semanales en reportes',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
  ...
  },
  {
    ...
    caos: {
      ...
      detail: 'Promedio: 3 sistemas sin integración',
      color: '#ef4444',
      colorRgb: '239,68,68',
    },
    orden: {
