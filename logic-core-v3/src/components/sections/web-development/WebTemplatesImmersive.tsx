...
const TEMPLATES: TemplateItem[] = [
    {
        ...
        description: "Impacto ciberpunk y lectura ultra rápida para marcas técnicas con tono agresivo.",
        accent: "#00ff41",
        rgb: "0,255,65",
    ...
    },
    {
        ...
        description: "Narrativa sensorial oscura para propuestas de autor que necesitan presencia única.",
        accent: "#d6bda0",
        rgb: "214,189,160",
    ...
    },
    {
        ...
        description: "Jerarquia limpia y estructura confiable para conversión directa en servicios premium.",
        accent: "#60a5fa",
        rgb: "96,165,250",
    ...
    },
    {
        ...
        description: "Sistema visual extremo para marcas que compiten por atención y diferenciación.",
        accent: "#ff3cac",
        rgb: "255,60,172",
