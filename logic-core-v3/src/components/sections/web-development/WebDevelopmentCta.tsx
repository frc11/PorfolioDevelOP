...
function MagneticButton({
    ...
    return (
        <motion.a
                ...
                autoHover
                    ? {
                        ...
                        boxShadow: [
                            ...
                            '0 0 0 1px rgba(125,211,252,0.36), 0 0 28px rgba(56,189,248,0.4), 0 14px 36px rgba(14,165,233,0.34)',
                            '0 14px 34px rgba(14,165,233,0.28)',
                        ],
                    }
                    : {
            ...
            whileTap={{ scale: 0.98 }}
            className="group/cta-primary relative inline-flex h-14 w-full max-w-[19.5rem] items-center justify-center overflow-hidden rounded-full border border-cyan-200/35 bg-[linear-gradient(135deg,#0bd3f5,#0ea5e9_38%,#2563eb)] px-8 text-[12px] font-extrabold uppercase tracking-[0.22em] text-white shadow-[0_14px_34px_rgba(14,165,233,0.28)] max-[425px]:h-12 max-[425px]:max-w-[17.75rem] max-[425px]:px-6 max-[425px]:text-[11px] max-[425px]:tracking-[0.18em] max-[375px]:h-11 max-[375px]:max-w-[16.5rem] max-[375px]:px-5 max-[375px]:text-[10.5px] max-[375px]:tracking-[0.14em]"
        >
            <span
                aria-hidden="true"
                ...
                style={{
                    background:
                        'radial-gradient(70% 130% at 50% 0%, rgba(224,242,254,0.34) 0%, rgba(125,211,252,0.1) 45%, transparent 72%), linear-gradient(90deg, rgba(255,255,255,0), rgba(255,255,255,0.4), rgba(255,255,255,0))',
                }}
            />
            {autoHover ? (
                <motion.span
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        'radial-gradient(120% 84% at 50% 0%, rgba(14,165,233,0.14) 0%, rgba(1,3,20,0) 58%), radial-gradient(92% 78% at 78% 92%, rgba(29,78,216,0.18) 0%, rgba(1,3,20,0) 70%), linear-gradient(180deg, rgba(1,3,20,0.96) 0%, rgba(1,2,16,1) 100%)',
                }}
            />
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        'repeating-linear-gradient(28deg, rgba(56,189,248,0.14) 0 1px, transparent 1px 22px), repeating-linear-gradient(94deg, rgba(125,211,252,0.1) 0 1px, transparent 1px 26px), repeating-linear-gradient(152deg, rgba(30,64,175,0.14) 0 1px, transparent 1px 28px)',
                    opacity: 0.3,
                    filter: 'blur(0.4px)',
                    mixBlendMode: 'screen',
            ...
            <div
                ...
                style={{
                    backgroundImage:
                        'repeating-radial-gradient(circle at 32% 46%, rgba(56,189,248,0.22) 0 1px, transparent 1px 9px), repeating-radial-gradient(circle at 68% 58%, rgba(96,165,250,0.18) 0 1px, transparent 1px 11px)',
                    opacity: 0.22,
                    filter: 'blur(0.25px)',
                    mixBlendMode: 'screen',
            ...
            <div
                ...
                style={{
                    background:
                        'radial-gradient(circle, rgba(14,165,233,0.18) 0%, rgba(59,130,246,0.1) 32%, rgba(6,10,30,0.04) 58%, transparent 76%)',
                    filter: 'blur(72px)',
            ...
            <div className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-center">
                <div className="relative isolate mx-auto w-full max-w-[20.75rem] max-[425px]:max-w-[19.25rem] max-[375px]:max-w-[16.75rem] sm:max-w-[29rem] md:max-w-[40rem] lg:max-w-[48rem] xl:max-w-[54rem]">
                    <div
                        ...
                        style={{
                            boxShadow: '0 0 0 1px rgba(34,211,238,0.22), 0 0 20px rgba(34,211,238,0.24), 0 0 40px rgba(14,165,233,0.18)',
                            opacity: 0.64,
                        }}
                    />
                    <div
                        ...
                        style={{
                            background:
                                'radial-gradient(58% 74% at 50% 0%, rgba(56,189,248,0.46) 0%, rgba(56,189,248,0.16) 54%, transparent 78%), radial-gradient(58% 74% at 50% 100%, rgba(14,165,233,0.4) 0%, rgba(14,165,233,0.14) 54%, transparent 78%), radial-gradient(72% 56% at 0% 50%, rgba(34,211,238,0.34) 0%, transparent 74%), radial-gradient(72% 56% at 100% 50%, rgba(34,211,238,0.34) 0%, transparent 74%)',
                    ...
                    <motion.div
                        ...
                        className="relative w-full overflow-hidden rounded-[2rem] border border-cyan-300/18 bg-[linear-gradient(155deg,rgba(6,14,30,0.86)_0%,rgba(4,10,24,0.94)_58%,rgba(3,8,20,0.92)_100%)] px-[clamp(14px,3.2vw,56px)] py-[clamp(18px,3.4vh,44px)] text-center shadow-[0_28px_84px_rgba(0,0,0,0.54)] backdrop-blur-sm lg:backdrop-blur-none max-[425px]:px-4 max-[425px]:py-5 max-[375px]:px-3 max-[375px]:py-4"
                    >
                        <div
                            aria-hidden="true"
                            className="pointer-events-none absolute inset-0"
                            style={{
                                background:
                                    'linear-gradient(145deg, rgba(255,255,255,0.05), transparent 36%, transparent 72%, rgba(34,211,238,0.08))',
                            }}
                        />
                        <div
                            aria-hidden="true"
                            className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(56,189,248,0.95),rgba(37,99,235,0.85),transparent)]"
                        />

                        <div className="relative z-10">
                            <div className="mb-3 inline-flex max-w-full items-center gap-1.5 rounded-full border border-amber-300/24 bg-amber-300/[0.08] px-3 py-1.5 max-[425px]:px-2.5 max-[425px]:py-1">
                                <span
                                    className="h-1.5 w-1.5 rounded-full bg-amber-300 shadow-[0_0_10px_rgba(252,211,77,0.9)]"
                            ...
                            <div className="mb-2 text-[9px] uppercase tracking-[0.24em] text-cyan-100/36 max-[425px]:text-[8px] max-[425px]:tracking-[0.2em] max-[375px]:tracking-[0.15em]">
                                SI HOY NO TE ENCUENTRAN, MAÑANA LE COMPRAN A OTRO
                            </div>
                            ...
                            <div className="mt-5 flex flex-col items-center justify-center gap-2 sm:mt-6 sm:flex-row sm:flex-wrap sm:gap-2.5">
                                    ...
                                    whileHover={
                                        prefersReducedMotion || enableAutoHover
                                            ...
                                            : {
                                                ...
                                                boxShadow: '0 0 0 1px rgba(34,211,238,0.24), 0 0 20px rgba(34,211,238,0.2)',
                                            }
                                    }
                                    animate={
                                    ...
                                    whileHover={
                                        prefersReducedMotion || enableAutoHover
                                            ...
                                            : {
                                                ...
                                                boxShadow: '0 0 0 1px rgba(96,165,250,0.22), 0 0 20px rgba(59,130,246,0.2)',
                                            }
                                    }
                                    animate={
                                ...
                                >
                                    <Clock3 className="size-4 text-cyan-100/80" />
                                    Respuesta promedio menor a 2 horas
                                </motion.div>
                            </div>
                            ...
                            <div className="mt-6 flex flex-col items-center gap-2.5 sm:mt-7 sm:gap-3">
                                ...
                                <div className="w-full max-w-[19rem] rounded-full border border-cyan-300/22 bg-cyan-300/[0.1] px-3 py-1.5 text-center text-[10px] font-semibold leading-[1.25] tracking-[0.03em] text-cyan-100/92 max-[425px]:max-w-[17.75rem] max-[375px]:max-w-[16.5rem] sm:w-auto sm:max-w-none sm:px-4 sm:text-[11px] sm:tracking-[0.04em]">
                                    Sin permanencia obligatoria - Sin costos ocultos
                                </div>

                                <button
                                    type="button"
                                    className={`group/cta-form-btn relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border border-white/12 bg-[linear-gradient(135deg,rgba(8,18,34,0.78),rgba(8,16,30,0.66))] px-6 py-3 text-sm text-white/72 transition-[border-color,color,box-shadow] duration-200 hover:border-cyan-200/40 hover:text-white hover:shadow-[0_0_20px_rgba(125,211,252,0.14)] ${enableAutoHover && isFormShineActive ? 'border-cyan-200/40 text-white shadow-[0_0_20px_rgba(125,211,252,0.14)]' : ''}`}
                                    onClick={() => {
                                        setShowForm(true)
                                        setTimeout(() => {
                                ...
                                >
                                    <span
                                        ...
                                        style={{
                                            background:
                                                'radial-gradient(65% 100% at 50% 0%, rgba(186,230,253,0.18) 0%, rgba(125,211,252,0.08) 44%, transparent 72%)',
                                        }}
                                    />
                                    <span
                                        aria-hidden="true"
                                        className={`pointer-events-none absolute top-[-2rem] h-[220%] w-14 rotate-[24deg] bg-[linear-gradient(90deg,rgba(255,255,255,0),rgba(224,242,254,0.9),rgba(186,230,253,0.35),rgba(255,255,255,0))] blur-[1px] transition-all duration-500 ease-out group-hover/cta-form-btn:left-[122%] group-hover/cta-form-btn:opacity-100 ${enableAutoHover && isFormShineActive ? 'left-[122%] opacity-100' : '-left-24 opacity-0'}`}
                                    />
                                ...
                                >
                                    <form
                                        ...
                                        className="rounded-[1.35rem] border border-cyan-300/16 bg-black/28 p-4 shadow-[0_0_28px_rgba(14,165,233,0.12)]"
                                    >
                                        <div className="flex flex-col gap-3">
                                            <input
                                                ...
                                                required
                                                className="w-full rounded-xl border border-white/12 bg-white/[0.04] px-4 py-3 text-sm text-white outline-none transition-colors focus:border-cyan-300/40"
                                            />
                                            <input
                                                type="tel"
                                            ...
                                            <select
                                                required
                                                defaultValue=""
                                                className="w-full appearance-none rounded-xl border border-white/12 bg-white/[0.04] px-4 py-3 text-sm text-white outline-none transition-colors focus:border-cyan-300/40"
                                            >
                                                <option value="" disabled hidden style={{ color: '#080810' }}>
                                                    Mi rubro...
                                                </option>
                                                <option value="gastronomia" style={{ color: '#080810' }}>Gastronomia</option>
                                            ...
                                            <textarea
                                                ...
                                                className="w-full resize-none rounded-xl border border-white/12 bg-white/[0.04] px-4 py-3 text-sm text-white outline-none transition-colors focus:border-cyan-300/40"
                                            />
