...
function LuminousAccordion({
    ...
    const accentRgb = tone === 'cyan' ? '34,211,238' : '139,92,246'
    const accentText = tone === 'cyan' ? 'text-cyan-200' : 'text-violet-200'
                ...
                return (
                    <motion.article
                        ...
                        style={{
                            ...
                            background: isOpen
                                ? `linear-gradient(145deg, rgba(9,20,34,0.88) 0%, rgba(6,12,26,0.92) 62%, rgba(8,18,34,0.86) 100%)`
                                : 'linear-gradient(145deg, rgba(9,14,30,0.72) 0%, rgba(7,12,26,0.66) 60%, rgba(9,14,30,0.7) 100%)',
                            boxShadow: isOpen
    ...
    return (
        <section className="relative z-10 w-full overflow-hidden bg-[#00010c] px-4 py-24 md:py-28">
            <div
                ...
                style={{
                    background:
                        'radial-gradient(120% 86% at 50% 0%, rgba(49,46,129,0.26) 0%, rgba(0,1,12,0) 58%), radial-gradient(96% 74% at 82% 90%, rgba(76,29,149,0.2) 0%, rgba(0,1,12,0) 68%), radial-gradient(80% 62% at 12% 16%, rgba(14,116,144,0.12) 0%, rgba(0,1,12,0) 64%)',
                }}
            />
                ...
                <svg viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice" className="h-full w-full">
                    <defs>
                        <linearGradient id="faq-question-stroke" x1="0%" y1="0%" x2="0%" y2="100%">
                            <stop offset="0%" stopColor="rgba(125,211,252,0.09)" />
                        ...
                        <linearGradient id="faq-question-fill" x1="0%" y1="0%" x2="0%" y2="100%">
                            ...
                            <stop offset="52%" stopColor="rgba(56,189,248,0.14)" />
                        ...
                        <pattern id="faq-question-lines" width="26" height="26" patternUnits="userSpaceOnUse" patternTransform="rotate(26)">
                            ...
                            <line x1="0" y1="0" x2="0" y2="26" stroke="rgba(186,230,253,0.16)" strokeWidth="2" />
                        </pattern>
