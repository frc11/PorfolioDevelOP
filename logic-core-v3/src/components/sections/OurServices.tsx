...
const MobileServiceCard = ({ title, tagline, icon: Icon, features, duration, theme, onClick }: ServiceCardProps) => {
    ...
    const isCyan = theme === 'cyan';
    // Theme Colors (Mobile adjusted, without group-hover prefixes for base states)
    const borderColor = isCyan ? "border-cyan-500/50" : "border-fuchsia-500/50";
    const shadowColor = isCyan ? "shadow-[0_20px_50px_-12px_rgba(34,211,238,0.3)]" : "shadow-[0_20px_50px_-12px_rgba(232,121,249,0.3)]";
    const bgGradient = isCyan
        ? "from-cyan-900/20 to-blue-900/20"
        : "from-fuchsia-900/20 to-purple-900/20";
    const accentText = isCyan ? "text-cyan-400" : "text-fuchsia-400";
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(([entry]) => {
            // If the card leaves the viewport and is currently flipped, reset it
    ...
    return (
        <div
            ref={cardRef}
            className="perspective-1000 w-full max-w-md h-[500px] cursor-pointer"
        ...
        >
            ...
            >
                {/* --- FRONT FACE --- */}
                <div
                    className={`absolute inset-0 backface-hidden bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 flex flex-col items-center justify-center gap-6 text-center shadow-xl ${isFlipped ? borderColor : ''} transition-colors duration-300 overflow-hidden`}
                    style={{ backfaceVisibility: "hidden" }}
                >
                    {/* Background Gradient */}
...
const OurServicesMobile = () => {
    ...
    return (
        <div className="relative py-60 bg-zinc-950 flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
                ...
                <div className="flex flex-col gap-12 w-full justify-center items-center perspective-origin-center">
                    <MobileServiceCard
...
const OurServicesDesktop = () => {
    ...
    return (
        <div className="relative min-h-screen py-75 bg-zinc-950 flex flex-col items-center justify-center overflow-hidden">
...
export const OurServices = () => {
    return (
        <section id="servicios" className="relative w-full bg-zinc-950">
            {/* MOBILE VIEW */}
