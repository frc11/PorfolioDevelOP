...
const VARIANT_STYLES: Record<CardVariant, string> = {
  default: 'rounded-2xl border border-white/10 bg-white/[0.02]',
  elevated: 'rounded-3xl border border-white/10 bg-white/[0.02]',
  interactive:
    'rounded-2xl border border-white/10 bg-white/[0.02] transition-colors hover:bg-white/[0.04]',
  ...
  subtle: 'rounded-2xl border border-white/[0.06] bg-white/[0.015] backdrop-blur-xl',
  highlighted:
    'rounded-2xl border border-cyan-500/25 bg-gradient-to-br from-cyan-500/[0.08] via-white/[0.02] to-transparent backdrop-blur-2xl shadow-[0_0_24px_rgba(6,182,212,0.08)]',
  flat: 'rounded-2xl border border-white/[0.08] bg-zinc-950/40',
}
